/**
 * Animation IDs required for PixelPal MVP and Sprint 2.
 */
...
/**
 * Dimensions for each individual animation frame in pixels.
 */
...
/**
 * Metadata definition for an animation.
 */
...
/**
 * Comprehensive animation manifest format.
 */
